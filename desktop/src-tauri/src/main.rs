...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            backend::tauri_commands::get_usb_track_detail,
            backend::tauri_commands::save_usb_track_analysis_edits,
            ...
            backend::tauri_commands::list_matching_track_ids,
            backend::tauri_commands::add_library_selection_to_playlist,
            backend::tauri_commands::remove_tracks_from_playlist,
            backend::tauri_commands::reorder_playlist_tracks,
            backend::tauri_commands::refresh_playlist_export_status,
            ...
            backend::tauri_commands::list_usb_devices,
            backend::tauri_commands::prune_usb_device,
            backend::tauri_commands::get_usb_device_name,
            backend::tauri_commands::set_usb_device_name,
            backend::tauri_commands::list_usb_backups,
            ...
            backend::tauri_commands::set_playback_metronome,
